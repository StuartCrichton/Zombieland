...
//-----------------------------------------------------------------------------
void PathA::InitializePathfinder()
{
...
//-----------------------------------------------------------------------------
int PathA::FindPath(int pathfinderID, int startingX, int startingY,
...
void PathA::ReadPath(int pathfinderID, int currentX, int currentY,
	int pixelsPerFrame)
{
	/*
...
//-----------------------------------------------------------------------------
int PathA::ReadPathX(int pathfinderID, int pathLocation)
{
	int x;
...
//-----------------------------------------------------------------------------
int PathA::ReadPathY(int pathfinderID, int pathLocation)
{
	int y;
	if (pathLocation <= pathLength[pathfinderID])
	{
